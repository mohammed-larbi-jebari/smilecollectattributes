...
{if $attribute.contentobject_attribute.content}
...
<tr>
<td>{$attribute.contentobject_attribute.content.original_filename|wash( xhtml )}</td>
<td>{$attribute.contentobject_attribute.content.mime_type|wash( xhtml )}</td>
<td>{$attribute.contentobject_attribute.content.filesize|si( byte )}</td>
</tr>
</table>
{else}
...
<input id="ezcoa-{if ne( $attribute_base, 'ContentObjectAttribute' )}{$attribute_base}-{/if}{$attribute.contentclassattribute_id}_{$attribute.contentclass_attribute_identifier}" class="box ezcc-{$attribute.object.content_class.identifier} ezcca-{$attribute.object.content_class.identifier}_{$attribute.contentclass_attribute_identifier}" name="{$attribute_base}_data_smilebinaryfilename_{$attribute.id}" type="file" />
</div>
