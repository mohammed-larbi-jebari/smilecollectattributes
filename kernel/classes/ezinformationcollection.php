...
class eZInformationCollection extends eZPersistentObject
{
    ...
    */
    static function removeContentObject( $delID )
    {
        ...
        $db->query( "DELETE FROM smilecollectionbinaryfile
                WHERE informationcollection_id IN ( SELECT id FROM ezinfocollection WHERE contentobject_id = '$delID')" );
    ...
    */
    static function removeCollection( $collectionID )
    {
        ...
        //delete information collected binary files
        $rows = $db->arrayQuery( "SELECT contentobject_id FROM ezinfocollection
    ...
    */
    static function cleanup()
    {
        $db = eZDB::instance();
        $db->begin();
        smileCollectionBinaryFile::cleanup();
    ...
    */
    ...
    {
       //delete all files
      // self::removeCollection( $this->attribute('id') );
